...
- (id)init:(NSString*)title {
	if ((self = [super init])) {
		SearchResultsPhotoSource *source  = [[SearchResultsPhotoSource alloc] initWithModel:CreateSearchModelWithCurrentSettings()];
		[(id<SearchResultsModel>)source setSearchTerms:@""];
		[source load:TTURLRequestCachePolicyDefault more:NO];
